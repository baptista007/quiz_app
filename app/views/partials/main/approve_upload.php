        ...
        <div class="container-fluid">
            <div class="row ">
                <div class="col-md-12 comp-grid">
                    <form role="form" enctype="multipart/form-data" class="form form-horizontal needs-validation ajax"  novalidate action="<?php print_link("main/approve_upload/" . $view_data['data_upload_id']) ?>" method="post" data-feedback-div="div-feedback">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-sm-8">
                                                    <select class="form-control" name="verify_action" id="verify_action">
                                                        <option value=""> -- select approval conclusion -- </option>
