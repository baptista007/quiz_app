...
<section class="page">
    <div class="container-fluid">
        <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <a href="<?php print_link("main/new_upload") ?>" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i class="fa fa-plus fa-sm text-white-50"></i> New Upload</a>
        </div>
    </div>
    <div  class="">
        <div class="container-fluid">
                                            ...
                                            foreach ($draft as $data) {
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="text-align: right;">
                                                        <a class="btn btn-sm btn-primary" href="<?php print_link("main/view_upload/{$data['data_upload_id']}"); ?>" >
                                                            <i class="fa fa-eye"></i>
                                                        </a>
                                                        <a class="btn btn-sm btn-danger recordDeletePromptAction has-tooltip" title="<?php print_lang('btn_delete_tooltip'); ?>" href="<?php print_link("main/delete_upload/{$data['data_upload_id']}"); ?>" >
